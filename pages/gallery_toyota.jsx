...
export default function GalleryBenz() {
  ...
  return (
    <SimpleLayout>
      <Container>
        <h1 className="text-center mb-4">Toyota</h1>
        <Row>
          <Col className="col-lg-4 col-12 mb-4 mb-lg-0">
            <Photo producer="Toyota" filename="carousel_1.jpg"/>
          </Col>
          <Col className="col-lg-4 col-12 mb-4 mb-lg-0">
            <Photo producer="Toyota" filename="carousel_2.jpg"/>
          </Col>
          <Col className="col-lg-4 col-12 mb-4 mb-lg-0">
            <Photo producer="Toyota" filename="carousel_3.jpg"/>
          </Col>
        </Row>
        <Row>
          <Col className="col-lg-4 col-12 mb-4 mb-lg-0">
            <Photo producer="Toyota" filename="carousel_4.jpg"/>
          </Col>
          <Col className="col-lg-4 col-12 mb-4 mb-lg-0">
            <Photo producer="Toyota" filename="carousel_5.jpg"/>
          </Col>
          <Col className="col-lg-4 col-12 mb-4 mb-lg-0">
