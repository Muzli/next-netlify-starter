        ...
        <div className="container-xl">
            <Link href="/">
                <a className="navbar-brand">
                    <img className="img-fluid" src="/formverk_logo.png" alt="Formverk merki"/>
                </a>
            </Link>
            ...
            <div className="collapse navbar-collapse" id="navbarsExample07XL">
                <ul className="navbar-nav mr-auto">
                    ...
                    <li className="nav-item">
                        <Link href="/articles">
                            <a className="nav-link">Réttingar</a>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link href="/write">
                            <a className="nav-link">Sprautun</a>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link href="/write">
                            <a className="nav-link">Brettakantar</a>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link href="/write">
                            <a className="nav-link">Formgerð</a>
                        </Link>
                    </li>
                </ul>
            </div>
